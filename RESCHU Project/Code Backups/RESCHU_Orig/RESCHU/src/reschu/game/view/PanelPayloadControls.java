...
//            btnCCW = new JButton("CCW");}
        try {
            urlImgZoomIn = new URL(url_prefix+"zoom_in.gif");
            btnZoomIn = new JButton(new ImageIcon(urlImgZoomIn));
        } catch (MalformedURLException urle) {
            btnZoomIn = new JButton("+");}
        try {
            urlImgZoomOut = new URL(url_prefix+"zoom_out.gif");
            btnZoomOut = new JButton(new ImageIcon(urlImgZoomOut));
        } catch (MalformedURLException urle) {
