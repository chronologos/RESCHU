...
public class MySpeed {
    ...
    final static public int SPEED_TIMER = 500 / SPEED_CONTROL; // UAV speed, originally 500
    final static public int SPEED_CLOCK = 1000 / SPEED_CONTROL; // total time range, originally 1000
