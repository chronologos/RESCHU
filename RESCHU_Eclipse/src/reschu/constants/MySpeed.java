...
public class MySpeed {
	...
	final static public int SPEED_CONTROL = 100;
    final static public int SPEED_TIMER = 5000 / SPEED_CONTROL;
    final static public int SPEED_CLOCK = 100000 / SPEED_CONTROL;
