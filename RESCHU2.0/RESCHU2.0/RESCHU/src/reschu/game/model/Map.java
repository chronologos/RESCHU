...
public class Map {
  ...
  public List<Target> getListUnassignedTarget() {return listUnassignedTarget; }
  public List<int[]> getListHazard() {return listHazard; }
  ...
  public synchronized void setCellType(int x, int y, int type) { mapArray[x][y] = type; }

  public synchronized int getCellType(int x, int y) { return mapArray[x][y]; }
